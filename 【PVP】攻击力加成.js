var priority = 100
var combatPower = 0.0
var attributeName = "【PVP】攻击力加成"
var attributeType = "UPDATE"
var placeholder = "pvpgjljc"
...
function run(Attr, entity, handle){
	...
	if (SX > 0) {
        // 注意：如果您的属性标签必须带(%)，请改为 "【PVP】攻击力: " + SX + "%"
		AttributeAPI.addSourceAttribute(data, attributeName, Arrays.asList("【PVP】攻击力: " + SX), false)
	}
	return false
}